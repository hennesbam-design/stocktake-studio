...
export default function CountScreenExample() {
    ...
    return (<CountScreen department={mockDepartment} areas={mockAreas} groups={mockGroups} items={mockItems} entries={entries} operatorName="Demo User" onBack={handleBack} onScanBarcode={handleScanBarcode} onAddEntry={handleAddEntry}/>);
}
