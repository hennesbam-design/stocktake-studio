...
function MenuDrawerDemo() {
    ...
    return (<div className="p-4">
      <div className="flex items-center justify-between">
        ...
        <MenuDrawer onExportCSV={handleExportCSV} onExportJSON={handleExportJSON} onImportCSV={handleImportCSV} onClearData={handleClearData} onDownloadTemplate={handleDownloadTemplate} adminPin={adminPin} onSetAdminPin={handleSetAdminPin}/>
      </div>
